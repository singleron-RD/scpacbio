...
2. Detect primer and correct barcode for HiFi/ccs reads ([`isoseq3`](https://github.com/PacificBiosciences/IsoSeq))
3. Splitlinker
...
```bash
nextflow run singleron-RD/scpacbio \
   -profile singularity \
   --input samplesheet.csv \
   --outdir <OUTDIR>
```

To run the pipeline with test dataset, using:
...
<!-- If you use fuxin3/scpacbio for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
